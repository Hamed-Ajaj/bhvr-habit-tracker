  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div>
          <h2 className="text-base md:text-lg font-medium md:font-semibold text-gray-900">
            {habit.name}
          </h2>
      ...
      <div className="flex gap-2 md:gap-4 items-center">
        ...
        <Trash onClick={() => deleteHabit.mutate(habit.id)} className="w-5 h-5 text-red-500 hover:text-red-700 cursor-pointer" />
      </div>
    </div>
  )
}
